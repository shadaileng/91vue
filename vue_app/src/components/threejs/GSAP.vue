...
onMounted(() => {
    ...
    */
    ...
    // yoyo: 往返
    // delay: 延迟
    tl.to(cube.position, {x: 25, duration: 2, repeat: -1, yoyo: true, onStart: ()=>{console.log('start')}, onComplete: ()=>{console.log('end')}})
        .to(cube.rotation, {x: Math.PI * 2, duration: 1.5, repeat: -1, yoyo: true, delay: .5})
